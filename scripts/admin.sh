...
/usr/bin/time -o ../results/ragtimer/2reaction_100time.txt python3 main.py 100 loose &> ../results/ragtimer/2reaction_100.txt
...
/usr/bin/time -o ../results/ragtimer/6reaction_100time.txt python3 main.py 100 loose &> ../results/ragtimer/6reaction_100.txt
...
/usr/bin/time -o ../results/ragtimer/8reaction_100time.txt python3 main.py 100 &> ../results/ragtimer/8reaction_100.txt
