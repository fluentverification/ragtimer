...
class test_v3 {
  public:
    ...
    virtual void inspector__check_guard_r5(unsigned reactant1);
    virtual void inspector__check_guard_r6(unsigned reactant1);
    virtual void inspector__check_guard_r1(unsigned reactant1, unsigned reactant2);
    ...
    virtual bool enabled_checker__is_enabled_r3(unsigned reactant1);
    ...
    virtual bool enabled_checker__is_enabled_r5(unsigned reactant1);
    virtual bool enabled_checker__is_enabled_r4(unsigned reactant1, unsigned reactant2);
    virtual void ext__protocol__update_r2();
    virtual void inspector__check_guard_r3(unsigned reactant1);
    virtual void __init();
    ...
    virtual bool enabled_checker__is_enabled_r1(unsigned reactant1, unsigned reactant2);
