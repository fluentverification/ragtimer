...
void test_v2::ext__protocol__update_r2(){
    {
        ivy_assume((protocol__idle == (0 & 1)), "test_v2.ivy: line 242");
        {
            bool loc__0;
    loc__0 = (bool)___ivy_choose(0,"loc:0",36);
            {
                ___ivy_stack.push_back(95);
                loc__0 = enabled_checker__is_enabled_r2(protocol__r_s2);
                ___ivy_stack.pop_back();
                ivy_assume(loc__0, "test_v2.ivy: line 243");
            }
        }
        ivy_assume(false, "test_v2.ivy: line 244");
        {
            bool loc__0;
    loc__0 = (bool)___ivy_choose(0,"loc:0",37);
            {
                ___ivy_stack.push_back(96);
                loc__0 = selector__execute_r2();
                ___ivy_stack.pop_back();
                if(loc__0){
                    {
                        ___ivy_stack.push_back(97);
                        inspector__check_guard_r2(protocol__r_s2);
                        ___ivy_stack.pop_back();
                        ___ivy_stack.push_back(98);
...
void test_v2::goal__achieved(unsigned v){
    ...
    {
        ivy_assert((((80 & 1023) < v) || (v == (80 & 1023))), "test_v2.ivy: line 24");
        protocol__idle = (1 & 1);
...
void test_v2::ext__protocol__update_r1(){
    {
        ivy_assume((protocol__idle == (0 & 1)), "test_v2.ivy: line 238");
        {
            bool loc__0;
    loc__0 = (bool)___ivy_choose(0,"loc:0",34);
            {
                ...
                ___ivy_stack.pop_back();
                ivy_assume(loc__0, "test_v2.ivy: line 239");
            }
        }
        {
            bool loc__0;
    loc__0 = (bool)___ivy_choose(0,"loc:0",35);
            {
...
void test_v2::inspector__check_guard_r1(unsigned reactant1){
    ...
    {
        ivy_assert((((1 & 1023) < reactant1) || (reactant1 == (1 & 1023))), "test_v2.ivy: line 56");
        ___ivy_stack.push_back(99);
...
void test_v2::inspector__check_guard_r2(unsigned reactant1){
    ...
    {
        ivy_assert((((1 & 1023) < reactant1) || (reactant1 == (1 & 1023))), "test_v2.ivy: line 61");
        ___ivy_stack.push_back(100);
...
void test_v2::ext__protocol__idling(){
    {
        ivy_assume((protocol__idle == (1 & 1)), "test_v2.ivy: line 249");
    }
}
