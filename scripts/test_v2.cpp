...
void test_v2::ext__protocol__update_r8(){
    {
        ivy_assume((protocol__idle == (0 & 1)), "test_v2.ivy: line 348");
        {
            bool loc__0;
    loc__0 = (bool)___ivy_choose(0,"loc:0",63);
            {
                ...
                ivy_assume(loc__0, "test_v2.ivy: line 349");
            }
        }
        {
            bool loc__0;
...
void test_v2::ext__protocol__update_r3(){
    {
        ivy_assume((protocol__idle == (0 & 1)), "test_v2.ivy: line 340");
        {
            bool loc__0;
    loc__0 = (bool)___ivy_choose(0,"loc:0",65);
            {
                ...
                ___ivy_stack.pop_back();
                ivy_assume(loc__0, "test_v2.ivy: line 341");
            }
        }
        {
            bool loc__0;
...
void test_v2::ext__protocol__update_r5(){
    {
        ivy_assume((protocol__idle == (0 & 1)), "test_v2.ivy: line 344");
        {
            bool loc__0;
    loc__0 = (bool)___ivy_choose(0,"loc:0",67);
            {
                ...
                ___ivy_stack.pop_back();
                ivy_assume(loc__0, "test_v2.ivy: line 345");
            }
        }
        {
            bool loc__0;
...
void test_v2::ext__protocol__idling(){
    {
        ivy_assume((protocol__idle == (1 & 1)), "test_v2.ivy: line 354");
        ivy_assert((protocol__idle == (0 & 1)), "test_v2.ivy: line 359");
    }
}
...
void test_v2::ext__protocol__fail_test(){
    {
        ivy_assume((protocol__idle == (0 & 1)), "test_v2.ivy: line 365");
        {
            bool loc__0;
    ...
    loc__2 = (bool)___ivy_choose(0,"loc:2",69);
            {
                ...
                ___ivy_stack.pop_back();
                ivy_assume(((loc__0 == false) && (loc__1 == false) && (loc__2 == false)), "test_v2.ivy: line 366");
            }
        }
        ivy_assert(false, "test_v2.ivy: line 370");
    }
}
