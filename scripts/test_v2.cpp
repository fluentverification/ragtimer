...
void test_v2::ext__protocol__update_r1(){
    {
        ivy_assume((protocol__idle == (0 & 1)), "test_v2.ivy: line 166");
        {
            bool loc__0;
    loc__0 = (bool)___ivy_choose(0,"loc:0",29);
            {
                ...
                ivy_assume(loc__0, "test_v2.ivy: line 167");
            }
        }
        {
            bool loc__0;
...
void test_v2::ext__protocol__idling(){
    {
        ivy_assume((protocol__idle == (1 & 1)), "test_v2.ivy: line 172");
        ivy_assert((protocol__idle == (0 & 1)), "test_v2.ivy: line 177");
    }
}
...
void test_v2::ext__protocol__fail_test(){
    {
        ivy_assume((protocol__idle == (0 & 1)), "test_v2.ivy: line 183");
        {
            bool loc__0;
    loc__0 = (bool)___ivy_choose(0,"loc:0",31);
            {
                ...
                loc__0 = enabled_checker__is_enabled_r1(protocol__r_s1);
                ___ivy_stack.pop_back();
                ivy_assume((loc__0 == false), "test_v2.ivy: line 184");
            }
        }
        ivy_assert(false, "test_v2.ivy: line 188");
    }
}
