...
void test_v2::ext__protocol__update_r6(){
    {
        ivy_assume((protocol__idle == (0 & 1)), "test_v2.ivy: line 261");
        {
            bool loc__0;
    loc__0 = (bool)___ivy_choose(0,"loc:0",48);
            {
                ...
                ___ivy_stack.pop_back();
                ivy_assume(loc__0, "test_v2.ivy: line 262");
            }
        }
        {
            bool loc__0;
...
void test_v2::ext__protocol__idling(){
    {
        ivy_assume((protocol__idle == (1 & 1)), "test_v2.ivy: line 267");
        ivy_assert((protocol__idle == (0 & 1)), "test_v2.ivy: line 272");
    }
}
...
void test_v2::ext__protocol__fail_test(){
    {
        ivy_assume((protocol__idle == (0 & 1)), "test_v2.ivy: line 278");
        {
            bool loc__0;
    ...
    loc__1 = (bool)___ivy_choose(0,"loc:1",50);
            {
                ...
                ___ivy_stack.pop_back();
                ivy_assume(((loc__0 == false) && (loc__1 == false)), "test_v2.ivy: line 279");
            }
        }
        ivy_assert(false, "test_v2.ivy: line 283");
    }
}
