...
void test_v2::inspector__check_guard_r4(unsigned reactant1, unsigned reactant2){
    ...
    {
        ivy_assert(((((1 & 1023) < reactant1) || (reactant1 == (1 & 1023))) && (((1 & 1023) < reactant2) || (reactant2 == (1 & 1023)))), "test_v2.ivy: line 108");
...
void test_v2::inspector__check_guard_r5(unsigned reactant1){
    ...
    {
        ivy_assert((((1 & 1023) < reactant1) || (reactant1 == (1 & 1023))), "test_v2.ivy: line 113");
...
void test_v2::inspector__check_guard_r6(unsigned reactant1){
    ...
    {
        ivy_assert((((1 & 1023) < reactant1) || (reactant1 == (1 & 1023))), "test_v2.ivy: line 118");
        ___ivy_stack.push_back(344);
        imp__inspector__check_guard_r6(reactant1);
        ___ivy_stack.pop_back();
    }
}
void test_v2::inspector__check_guard_r1(unsigned reactant1, unsigned reactant2){
    __ivy_out  << "< inspector.check_guard_r1" << "(" << reactant1 << "," << reactant2 << ")" << std::endl;
    {
        ivy_assert(((((1 & 1023) < reactant1) || (reactant1 == (1 & 1023))) && (((1 & 1023) < reactant2) || (reactant2 == (1 & 1023)))), "test_v2.ivy: line 93");
...
void test_v2::inspector__check_guard_r2(unsigned reactant1){
    ...
    {
        ivy_assert((((1 & 1023) < reactant1) || (reactant1 == (1 & 1023))), "test_v2.ivy: line 98");
...
void test_v2::ext__protocol__idling(){
    {
        ivy_assume((protocol__idle == (1 & 1)), "test_v2.ivy: line 585");
        ivy_assert((protocol__idle == (0 & 1)), "test_v2.ivy: line 590");
    }
}
...
void test_v2::ext__protocol__fail_test(){
    {
        ivy_assume((protocol__idle == (0 & 1)), "test_v2.ivy: line 596");
        {
            bool loc__0;
    ...
    loc__5 = (bool)___ivy_choose(0,"loc:5",116);
            {
                ...
                ___ivy_stack.pop_back();
                ivy_assume(((loc__0 == false) && (loc__1 == false) && (loc__2 == false) && (loc__3 == false) && (loc__4 == false) && (loc__5 == false)), "test_v2.ivy: line 597");
            }
        }
        ivy_assert(false, "test_v2.ivy: line 601");
    }
}
...
void test_v2::ext__protocol__update_r2(){
    {
        ivy_assume((protocol__idle == (0 & 1)), "test_v2.ivy: line 563");
        {
            bool loc__0;
    loc__0 = (bool)___ivy_choose(0,"loc:0",119);
            {
                ...
                ___ivy_stack.pop_back();
                ivy_assume(loc__0, "test_v2.ivy: line 564");
            }
        }
        {
            bool loc__0;
...
void test_v2::inspector__check_guard_r3(unsigned reactant1){
    ...
    {
        ivy_assert((((1 & 1023) < reactant1) || (reactant1 == (1 & 1023))), "test_v2.ivy: line 103");
...
void test_v2::ext__protocol__update_r1(){
    {
        ivy_assume((protocol__idle == (0 & 1)), "test_v2.ivy: line 559");
        {
            bool loc__0;
    loc__0 = (bool)___ivy_choose(0,"loc:0",114);
            {
                ...
                loc__0 = enabled_checker__is_enabled_r1(protocol__r_s1, protocol__r_s2);
                ___ivy_stack.pop_back();
                ivy_assume(loc__0, "test_v2.ivy: line 560");
            }
        }
        {
            bool loc__0;
...
void test_v2::ext__protocol__update_r3(){
    {
        ivy_assume((protocol__idle == (0 & 1)), "test_v2.ivy: line 567");
        {
            bool loc__0;
    loc__0 = (bool)___ivy_choose(0,"loc:0",117);
            {
                ...
                ___ivy_stack.pop_back();
                ivy_assume(loc__0, "test_v2.ivy: line 568");
            }
        }
        {
            bool loc__0;
...
void test_v2::ext__protocol__update_r4(){
    {
        ivy_assume((protocol__idle == (0 & 1)), "test_v2.ivy: line 571");
        {
            bool loc__0;
    loc__0 = (bool)___ivy_choose(0,"loc:0",121);
            {
                ...
                ___ivy_stack.pop_back();
                ivy_assume(loc__0, "test_v2.ivy: line 572");
            }
        }
        {
            bool loc__0;
...
void test_v2::ext__protocol__update_r6(){
    {
        ivy_assume((protocol__idle == (0 & 1)), "test_v2.ivy: line 579");
        {
            bool loc__0;
    loc__0 = (bool)___ivy_choose(0,"loc:0",123);
            {
                ...
                ___ivy_stack.pop_back();
                ivy_assume(loc__0, "test_v2.ivy: line 580");
            }
        }
        {
            bool loc__0;
...
bool test_v2::enabled_checker__is_enabled_r1(unsigned reactant1, unsigned reactant2){
    bool y;
    y = (bool)___ivy_choose(0,"fml:y",0);
    if(((((1 & 1023) < reactant1) || (reactant1 == (1 & 1023))) && (((1 & 1023) < reactant2) || (reactant2 == (1 & 1023))))){
        y = true;
...
void test_v2::ext__protocol__update_r5(){
    {
        ivy_assume((protocol__idle == (0 & 1)), "test_v2.ivy: line 575");
        {
            bool loc__0;
    loc__0 = (bool)___ivy_choose(0,"loc:0",125);
            {
                ...
                ___ivy_stack.pop_back();
                ivy_assume(loc__0, "test_v2.ivy: line 576");
            }
        }
        {
            bool loc__0;
...
void test_v2::imp__inspector__check_guard_r1(unsigned reactant1, unsigned reactant2){
    {
    }
}
