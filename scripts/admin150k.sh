...
/usr/bin/time -o ../results/ragtimer/2reaction_150000time.txt python3 main.py 150000 loose &> ../results/ragtimer/2reaction_150000.txt
...
/usr/bin/time -o ../results/ragtimer/6reaction_150000time.txt python3 main.py 150000 loose &> ../results/ragtimer/6reaction_150000.txt
...
/usr/bin/time -o ../results/ragtimer/8reaction_150000time.txt python3 main.py 150000 &> ../results/ragtimer/8reaction_150000.txt
