...
void test_v3::ext__protocol__update_r8(){
    {
        ivy_assume((protocol__idle == (0 & 1)), "test_v3.ivy: line 350");
        {
            bool loc__0;
    loc__0 = (bool)___ivy_choose(0,"loc:0",63);
            {
                ...
                ivy_assume(loc__0, "test_v3.ivy: line 351");
            }
        }
        ivy_assume((((protocol__r3_executions + protocol__r8_executions) & 1023) < (50 & 1023)), "test_v3.ivy: line 352");
        {
            bool loc__0;
...
void test_v3::__init(){
    {
        ...
        }
        {
            ...
            protocol__r_g = (50 & 1023);
            protocol__r_ga = (0 & 1023);
            protocol__r_gbg = (0 & 1023);
...
void test_v3::ext__protocol__update_r3(){
    {
        ivy_assume((protocol__idle == (0 & 1)), "test_v3.ivy: line 340");
        {
            bool loc__0;
    loc__0 = (bool)___ivy_choose(0,"loc:0",65);
            {
                ...
                ___ivy_stack.pop_back();
                ivy_assume(loc__0, "test_v3.ivy: line 341");
            }
        }
        ivy_assume((((protocol__r3_executions + protocol__r8_executions) & 1023) < (50 & 1023)), "test_v3.ivy: line 342");
        {
            bool loc__0;
...
void test_v3::ext__protocol__update_r5(){
    {
        ivy_assume((protocol__idle == (0 & 1)), "test_v3.ivy: line 345");
        {
            bool loc__0;
    loc__0 = (bool)___ivy_choose(0,"loc:0",67);
            {
                ...
                ___ivy_stack.pop_back();
                ivy_assume(loc__0, "test_v3.ivy: line 346");
            }
        }
        ivy_assume((protocol__r5_executions < (50 & 1023)), "test_v3.ivy: line 347");
        {
            bool loc__0;
...
void test_v3::ext__protocol__idling(){
    {
        ivy_assume((protocol__idle == (1 & 1)), "test_v3.ivy: line 357");
    }
}
...
void test_v3::ext__protocol__fail_test(){
    {
        ivy_assume((protocol__idle == (0 & 1)), "test_v3.ivy: line 362");
        {
            bool loc__0;
    ...
    loc__2 = (bool)___ivy_choose(0,"loc:2",69);
            {
                ...
                ___ivy_stack.pop_back();
                ivy_assume((((loc__0 == false) && (loc__1 == false) && (loc__2 == false)) || ((((50 & 1023) < protocol__r5_executions) || (protocol__r5_executions == (50 & 1023))) && (((50 & 1023) < ((protocol__r3_executions + protocol__r8_executions) & 1023)) || (((protocol__r3_executions + protocol__r8_executions) & 1023) == (50 & 1023))))), "test_v3.ivy: line 363");
            }
        }
        ivy_assert(false, "test_v3.ivy: line 369");
    }
}
