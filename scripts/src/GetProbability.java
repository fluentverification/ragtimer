...
public class BuildModel
{
  ...
  public void run()
  {
    try {
      ...
      // Welcome message
      if (DO_PRINT) System.out.println("Simulating paths to accumulate probabilities WITHOUT building a model.");
      ...
      // TODO: Read in the traces from IVy to CPP rather than a single line
